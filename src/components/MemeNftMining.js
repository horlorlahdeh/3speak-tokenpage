              ...
              <div className='col-md-12'>
                <div className='Slide-Header'>
                  ...
                  <p className='Slide-Title-Desc text-center'>
                    ...
                    with NFT's and issue them to the token holders who stake the
                    most of a communities' or a creator's token. Users can earn
                    collectable memes by staking the tokens of a creator or a
                    community
                  </p>
                </div>
              </div>
            ...
            <div className='row'>
              <div className='col-md-7'>
                ...
                <div className='row' style={{ marginBottom: '18px' }}>
                  <div className='col-md-12'>
                    <strong>NOTE:</strong> Staking a creator's token to mine NFT
                    Memes is the a similar idea to holding a stock and receiving
                    dividends
                  </div>
                </div>
              </div>
                ...
                <div className='Sub-Slide-Header' style={{ marginTop: '0' }}>
                  <div className='row'>
                    <div className='col-12'>
                      <h5>
                        NFT Memes are like rare, collectable football cards and
                      ...
                      <div className='row' style={{ marginBottom: '8px' }}>
                        ...
                        <div className='col-10'>
                          Users can earn collectable memes by staking the tokens
                          of a creator or a community
                        </div>
                      </div>
                      <div className='row' style={{ marginBottom: '8px' }}>
                        <div className='col-1'>
                        ...
                        <div className='col-10'>
                          Collect your favourite Memes by displaying them on the
                          front ends of your community or creators
                        </div>
                      </div>
                      ...
                      <div className='row' style={{ marginBottom: '8px' }}>
                        ...
                        <div className='col-10'>
                          Prove the authenticity of your collectable meme NTF by
                          being able to verify that its original issuer was the
                          creator themselves
                        </div>
                      </div>
                    </div>
