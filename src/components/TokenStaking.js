                    ...
                    <div className='row'>
                      <div className='col-12'>
                        ...
                        <div className='row' style={{ marginBottom: '8px' }}>
                          ...
                          <div className='col-10'>IVP’s (Independent Video Platforms)</div>
                        </div>
                        <div className='row' style={{ marginBottom: '8px' }}>
                          <div className='col-1'>
                            <img alt='token system' src="data:image/png;base64," />
